...
/**
 * 旧形式との互換性のための関数（廃止予定）
 * @deprecated 新しいcreateeCFAdjustmentAccountとcreateBSChangeAccountを使用してください
 */
export const createCashflowAccount = (account) => {
  console.warn(
    "createCashflowAccount is deprecated. Use createCFAdjustmentAccount or createBSChangeAccount instead."
  );
